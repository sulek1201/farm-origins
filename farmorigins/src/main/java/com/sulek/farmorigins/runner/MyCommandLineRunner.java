...
public class MyCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category category1 = new Category(0L, "süt ürünleri", "süt ürünleri");
        Category category2 = new Category(1L, "et ürünleri", "et ürünleri");
        Category category3 = new Category(2L, "bitkisel ürünleri", "bitkisel ürünleri");
        List<Category> categoryList = List.of(category1, category2,category3);
        categoryRepository.saveAll(categoryList);
        categoryRepository.flush();
        UnitType unitType1 = new UnitType(0L, "kg", "kilogram");
        UnitType unitType2 = new UnitType(1L, "litre", "litre");
        UnitType unitType3 = new UnitType(2L, "adet", "adet");
